...
NY_GIS = {'Name': 'New York', 'State': 'NY', 'lolelon': -74.25, 'lolelat': 40.47, 'uprelon': -73.65,
        'uprelat': 40.89, 'latlat0':40.67, 'lonlon0': -74.21, 'shp_path': 'NewNYzips/nyu_2451_34509',
        'shp_nickname': 'nyzips', 'Firehouses_coords': 'NewNYzips/FDNY_Firehouse_Listing.csv'}
...
print('Now processing: ', NY_GIS['Name'])

map = Basemap(llcrnrlon= NY_GIS['lolelon'],llcrnrlat= NY_GIS['lolelat'],urcrnrlon=NY_GIS['uprelon'],urcrnrlat=NY_GIS['uprelat'],
             resolution='h', projection='tmerc', lat_0 = NY_GIS['latlat0'], lon_0 = NY_GIS['lonlon0'])
map.drawmapboundary(fill_color='aqua')
map.fillcontinents(color='linen',lake_color='aqua')
map.drawcoastlines()
map.drawrivers()
GIS_zips = map.readshapefile(NY_GIS['shp_path'], NY_GIS['shp_nickname'])
...
with open(NY_GIS['Firehouses_coords']) as FD_locs:
...
plt.legend()
plt.savefig(NY_GIS['Name'].replace(' ', '_')+'___original', frameon = False, bbox_inches='tight')
